...
Previously, I interned at **LIGHTSPEED STUDIOS**, where, under the mentorship of [Youzhao Yang](https://scholar.google.com/citations?user=MOaJ_A0AAAAJ&hl=zh-CN&oi=ao), I used reinforcement learning to train AI bots for **LOLM** to behave more like human players, with the goal of improving user retention and increasing daily active users (DAU). I also interned at **JD Retail, JD.COM**, collaborating with [Dr. Wei Feng](https://scholar.google.com.hk/citations?user=FvIAct4AAAAJ&hl=zh-CN&oi=sra) on advertising image generation driven by Click-Through Rate (CTR) optimization.
